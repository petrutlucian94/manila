...
class ServiceInstanceManager(object):
    ...
    def _create_service_instance(self, context, instance_name, network_info):
        ...
        try:
            create_kwargs = self._get_service_instance_create_kwargs() or {}
    ...
    def _get_service_instance_create_kwargs(self):
        # Allows service instance managers inheriting this class to easily
        # add arguments to the server create method.
        return None
